...
public partial class hiphap_page_blackpink : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            sourceControl.Src = "~/hiphap music/060. BLACKPINK-04-Bet You Wanna (Feat. Cardi B) - utorank.com.mp3";
            sourceControl1.Src = "~/idol music/003. BLACKPINK-05-Lovesick Girls - utorank.com.mp3";
            string connectionString = @"server=(localdb)\MSSQLLocalDB;Integrated Security=true; database=PALYLIST_USER";
            SqlConnection Con = new SqlConnection(connectionString);
            SqlCommand Cmd = new SqlCommand();
            Cmd.Connection = Con;
            Cmd.CommandText = "SELECT * FROM blckpink";
            Con.Open();
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        if (Session["id"] == null)
        {
            ...
            Cmd_1.CommandText = "SELECT * FROM blckpink";
            Con_1.Open();
        ...
        else
        {
            ...
            else
            {
                ...
                SqlCommand Cmd = new SqlCommand();
                Cmd.Connection = Con;
                Cmd.CommandText = "INSERT INTO blckpink (comment) VALUES " + "( '" + TextBox1.Text + "' )";
                Con.Open();
